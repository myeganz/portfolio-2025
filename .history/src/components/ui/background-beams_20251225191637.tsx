  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute h-full w-full bg-linear-to-r from-transparent via-neutral-900 to-transparent opacity-40 blur-3xl"></div>
        <div className="absolute top-0 left-0 h-125 w-125 bg-blue-500/20 blur-[100px] rounded-full mix-blend-screen opacity-50 animate-blob"></div>
        <div className="absolute bottom-0 right-0 h-125 w-125 bg-purple-500/10 blur-[100px] rounded-full mix-blend-screen opacity-50 animate-blob animation-delay-2000"></div>
