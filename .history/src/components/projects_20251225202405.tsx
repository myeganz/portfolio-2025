...
const PROJECTS = [
    ...
    },
    {
      ...
      videoSrc: "", // Make sure to record a quick scroll of your site!
      posterSrc: "/images/portofolio.png",
    },
  ];
      ...
      >
        ...
        <div className="relative h-56 w-full overflow-hidden bg-neutral-900">
          ...
          {project.videoSrc ? (
            ...
            // If NO video, just show the image (Best for the Portfolio Card)
            <div className="h-full w-full relative">
               <img 
                 ...
                 className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
               />
               {/* Optional: Add a 'View Source' overlay */}
               <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="px-3 py-1 bg-blue-600 rounded-full text-xs text-white font-bold">
                    View Source Code
                  </span>
               </div>
            </div>
