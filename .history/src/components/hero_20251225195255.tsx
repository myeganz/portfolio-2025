    ...
    >
      ...
      <div className="relative z-20 w-full max-w-6xl px-4 md:px-8 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        <div className="relative shrink-0">
          <div className="w-48 h-48 md:w-80 md:h-80 rounded-full border-4 border-neutral-800/50 shadow-2xl overflow-hidden relative  transition-all duration-500">
            <Image
              src="/avatar.png" 
              alt="Profile photo"
              fill
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-blue-100 text-lg md:text-xl max-w-lg leading-relaxed mb-8 [text-shadow:0_0_10px_#60a5fa,0_0_20px_#2563eb]">
            Solving problems. <br />
            Continuously exploring technologies. <br />
            Drive innovation.
          </p>
