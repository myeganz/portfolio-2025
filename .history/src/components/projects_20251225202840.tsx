...
const PROJECTS = [
  {
    ...
    description: "A secure payment solution for schools utilizing RFID cards and biometric fingerprint authentication. Ensures cashless, organized, and theft-free transactions.",
  ...
  },
  {
    ...
    description: "A centralized digital hub for school information. Features a dynamic portal allowing staff and users to update content and data directly.",
    tags: ["Laravel", "CMS Development", "Dynamic Content", "Bootstrap"],
  ...
  },
  {
    ...
    tags: ["Next.js 16", "React", "Tailwind CSS", "Framer Motion"],
    videoSrc: "", // No video
    posterSrc: "/images/portofolio.png", // Make sure this image exists!
  },
];
...
function ProjectCard({ project }: { project: typeof PROJECTS[0] }) {
  ...
  return (
    <div 
      className="group relative rounded-3xl border border-neutral-800 bg-neutral-900/40 overflow-hidden hover:border-neutral-600 transition-colors duration-500 flex flex-col h-full"
    ...
    >
      ...
      <div className="relative h-56 w-full overflow-hidden bg-neutral-900 shrink-0">
        ...
        {project.videoSrc ? (
          ...
          // OPTION B: Static Image Project (Your Portfolio)
